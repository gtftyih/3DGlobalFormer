...
class opts():
    ...
    def init(self):
        ...
        self.parser.add_argument('--root_path', type=str, default='/home/(your_name)/3DGlobalFormer/dataset/')
        ...
        self.parser.add_argument('--std', type=int, default=0)
        ...
        ##another##
        self.parser.add_argument('--previous_dir_pre', type=str, default='')
        self.parser.add_argument('--previous_name_pre', type=str, default='')
        self.parser.add_argument('--previous_dir_agg', type=str, default='')
        self.parser.add_argument('--previous_name_agg', type=str, default='')
